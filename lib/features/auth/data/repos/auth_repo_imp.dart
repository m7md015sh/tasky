...
class AuthRepoImp extends AuthRepo{
  ...
  @override
  Future<Either<Failure, LoginModel>> login(String phone, String password) async{
    try{
      var data= await apiService.post(endPoint: 'auth/login',phone: phone,password: password);
