...
import 'package:tasky/features/home/data/repo/home_repo_imp.dart';
...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) {
        return HomeCubit(HomeRepoImp(ApiService(Dio())))..getAllTasks(1);
      },
      child: Scaffold(
        ...
        body: SafeArea(
          child: Column(
            ...
            children: [
              ...
              const Expanded(child: ListViewTask())
            ],
          ),
        ),
      ),
