...
class TitleAndForm extends StatelessWidget {
  const TitleAndForm({super.key, required this.title, required this.hint, required this.maxLines});
  final String title;
  final String hint;
  final int maxLines;
  ...
  Widget build(BuildContext context) {
    return  Padding(
      ...
      child: Column(
        ...
        children: [
          Text(title,style: getRegularStyle(color: ColorManager.grey,fontSize: FontSize.s12.sp),),
          SizedBox(
            height: AppSize.s4.h,
          ),
